...
def fetch_text_key():
    ...
    while True:
        ...
        if all(char.isalpha() for char in text_key) and len(text_key)>=7:
            return text_key
        else:
            print("Text key should only contain alphabets and have a minimum length of 7 characters. Try again.")
